        ...
        <div className="max-w-4xl">
          ...
          <div className="flex items-center bg-white rounded-2xl p-2 shadow-brand max-w-2xl">
            <div className="flex-1 flex items-center">
              ...
              <Input placeholder="Search events, news, students..." className="border-0 bg-transparent text-lg placeholder:text-muted-foreground focus-visible:ring-0" />
            </div>
            <Button size="lg" className="bg-gradient-primary hover:opacity-90 text-white rounded-xl px-8 shadow-none border-0">
